...
try{
	...
	//Step 3: To verify that user will not be able to generate weekly summary report for more than 2 months - Step 1
	...
	//Step 4: To verify that user will not be able to generate weekly summary report for more than 2 months - Step 2

	'click GenerateReport button'
	WebUI.click(findTestObject('ReportsPage/generateReport'))


	String errMessage = CustomKeywords.'uiaction.CommonUIActions.getText'(findTestObject('ReportsPage/invalidRange'))
	...
	//Step 5: To verify that user is able to generate weekly report for maximum of 2 months
	...
	endDate=CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","EndDate2")
	...
	toDateValue =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","toDate2")
	if(!dateAttr.equals(toDateValue))
	{
		if(TCflag)
			TCflag=false
